...
public class CellView : EnhancedScrollerCellView
{
    ...
    {
        if (data.is_mine == false)
        {
            m_rightRootUI.gameObject.SetActive(false);
            m_leftTextUI.text = data.m_input_data;
            m_leftTextRectUI.sizeDelta = new Vector2(data.m_width, data.m_height);
            m_leftTextRectUI.sizeDelta = new Vector2(m_leftTextUI.preferredWidth, m_leftTextUI.preferredHeight);
        ...
        else
        {
            ...
            m_rightTextRectUI.sizeDelta = new Vector2(data.m_width, data.m_height);
            m_rightTextRectUI.sizeDelta = new Vector2(m_rightTextUI.preferredWidth, m_rightTextUI.preferredHeight);
